...
public SavingsAccount1(String name, String mobile, double deposit) {
...
public CurrentAccount1(String name, String mobile, double deposit) {
	super(name,mobile, deposit);
...
public class BankAccount {
	public static void main(String[]args) {
	   ...
	   try {
		...
		switch(type) {
		case "savings":
			account=new SavingsAccount1(name, mobile, deposit);
			break; 
		case "current":
			account=new CurrentAccount1(name,mobile,deposit);
			break;
